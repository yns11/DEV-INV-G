...
tests/                      2244 contrôles, ~45 s ; 63 exigent un PostgreSQL, ignorés sinon
...
make test            # 2244 contrôles, ~45 s ; 63 ignorés sans PostgreSQL
make lint            # ruff + tsc
make check           # les deux
make dev-api         # API avec rechargement, port 8000
make dev-ui          # Vite avec proxy vers l'API, port 5173

npm --prefix frontend run test   # 348 contrôles navigateur (vitest + jsdom)
