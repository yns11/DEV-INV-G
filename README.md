...
tests/                      3340 contrôles ; 422 exigent un PostgreSQL, ignorés sinon
...
make test            # 3340 contrôles ; 422 ignorés sans PostgreSQL
make lint            # ruff + tsc
make check           # les deux
make dev-api         # API avec rechargement, port 8000
make dev-ui          # Vite avec proxy vers l'API, port 5173

npm --prefix frontend run test   # 630 contrôles navigateur (vitest + jsdom)
