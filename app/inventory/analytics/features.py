...
FEATURE_COLUMNS: dict[str, str] = {
    ...
    "book_qty": "Quantité stock livre",
    "counted_qty": "Quantité comptée retenue",
    "adjusted_qty": "Quantité des ajustements postés",
    "book_value": "Valeur stock livre (€)",
    "variance_qty": "Écart quantité = compté − livre",
    "variance_value": "Écart valeur (€)",
    "abs_variance_value": "|Écart valeur| (€)",
    "residual_qty": "Écart résiduel après ajustements",
    "residual_value": "Écart résiduel valorisé (€)",
    "variance_ratio": "|Écart| / stock livre (NaN si livre = 0)",
    "is_material": "Écart au-delà des seuils de son type",
    "counted_only": "Compté sans stock livre",
    "book_only": "Stock livre jamais compté",
    "book_value_share": "Part du stock livre total",
    ...
    *,
    ...
    for line in variances:
        ...
        records.append({
            ...
            "residual_qty": _f(line.residual_qty),
            "residual_value": _f(line.residual_value),
