...
- **Modifier la mise en page ne touche pas ce qui a été compté.** Une écriture de feuille ne change que les champs dont elle parle : l'aperçu montre le document — l'ordre, les intertitres, les sections — et n'affiche ni quantité, ni commentaire, ni désignation ; il n'en envoie donc aucun, et la ligne garde les siens. *Sans cette règle, réordonner une feuille effaçait les comptages relevés en atelier et les commentaires qui les expliquent, sous un message annonçant « lignes enregistrées ». La réciproque est aussi nécessaire : un écran qui **affiche** la colonne comptage en parle, et une case qu'on y vide doit se vider en base — sans quoi corriger une erreur n'aurait aucun effet.* **[CO]** — invariant d'intégrité ; réalisé, `test_ecriture_partielle_de_feuille.py`.
...
- **Répartition des largeurs** : deux arbitrages successifs, en sens inverse, et c'est le second qui vaut. D'abord la référence prime — *« diminuer la taille des colonnes désignation, comptage et unité de 10 %, 5 % et 20 % respectivement pour augmenter la taille de la colonne Référence »* — parce qu'une référence coupée n'identifie plus rien. Puis, une fois des feuilles réelles sorties de l'imprimante, la désignation reprend ce que les trois autres avaient de trop : *« diminuer la largeur des colonnes Référence, Comptage et Unité de 3 %, 2 % et 15 % de leur largeur actuelle respectivement et allouer l'espace gagné à la colonne Désignation »*. **[EC]** pour les deux. **Le repreneur doit retenir l'ordre — la désignation prime tant que la référence tient en entier — et non ces pourcentages, qui étaient relatifs à une mise en page donnée.**
- **Les commentaires doivent tenir dans leur case** sur le relevé imprimé. **[EC]**
- **La référence, le pied de page et le numéro de page se lisent de loin** : en gras et un demi-point au-dessus du corps du texte. **[EC]** — *« écrire les pieds de page, le numéro de page et les numéros d'article (références) en gras et avec une taille police légèrement plus grande »*. La feuille se lit debout, au-dessus d'un bac, sous l'éclairage d'un atelier : la référence est la seule chose qui dit *quelle pièce* on tient, le pied de page la seule qui permette de reclasser une page tombée d'une liasse de deux cents. *Le reste de la ligne reste au corps du texte — une feuille entièrement en gras ne distingue plus rien.*
- **La désignation imprimée est bornée à 45 caractères.** **[EC]** — *« pour le nombre de caractère max à afficher dans la désignation d'un article dans les feuilles imprimées, le passer à 41 caractères »*, puis *« augmenter le nombre max de caractères de désignation de 41 à 45 »* une fois la colonne élargie. *Une seconde borne, sur la largeur réelle de la colonne, garde ce chiffre sûr : une désignation d'atelier de 45 caractères tient, une suite de 45 lettres larges déborderait — et, la hauteur de ligne étant imposée, elle se replierait par-dessus les lignes suivantes.* Le repreneur doit retenir les deux : un compte de caractères lisible dans l'exigence, et l'obligation que le texte tienne.
